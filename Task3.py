...
def f7():
	...
	if ad_name=="":
		...
		showerror("Error","Only use letters ")
	elif (ad_name=="Abhay Alange") and (ad_pass=="Abhay"):
		ad.withdraw()
		sw.deiconify()
	else:
...
us.title("Enquiry Management System")
...
ad.title("Enquiry Management System")
...
sw.title("Enquiry Management System")
...
tw.title("Enquiry Management System")
...
fw.title("Enquiry Management System")
